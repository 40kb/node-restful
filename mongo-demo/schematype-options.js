...
const courseSchema = new mongoose.Schema({
  ...
  price: {
    ...
    // == SCHEMA TYPE OPTIONS ==
    get: v => Math.round(v), // 什么时候会被调用？ when you get the value from the property, will be call
    set: v => Math.round(v), // 什么时候会被调用？when you set the value of the property, will ben call
  } 
});
